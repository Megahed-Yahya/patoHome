...
document.querySelector(".bars").addEventListener("click", () => {
  document.querySelector(".second-bars").style.display = "block";
  document.querySelector(".second-bars").style.color = "red";
  document.querySelector(".nav-bar").style.display = "block";
});

document.querySelector(".second-bars").addEventListener("click", () => {
  document.querySelector(".second-bars").style.display = "none";
